...
「Hydrangea Breath」は、わずか2分間で重い思考を手放し、閉じ込めた感情を解放するために作られた、ミニマルでインタラクティブな感情解放Webアプリです。
...
1. Personalize Your Canvas (キャンバスのカスタマイズ)
   ...
   * アプリを開くと、現在の心の状態を反映できるように、紫陽花の数を自由に増やしたり減らしたりできます。自身が満足するまで数を調整してください。
...
入力された言葉は、画面に表示されるためだけに、ブラウザの一時的なメモリ上に存在します。ページを閉じれば、その言葉はどこにも残りません。
